...
class AkataboResponsive {
// context
  final BuildContext context;

  AkataboResponsive({required this.context});
  ...
  bool get isMobileScreen =>
      AkataboResponsive.isMobile(context) ||
      AkataboResponsive.isMediumMobile(context) ||
      AkataboResponsive.isSmallMobile(context);

  /// getter for isTablet or isMediumTablet or isLargeTablet
  bool get isTabletScreen =>
      AkataboResponsive.isTablet(context) ||
      AkataboResponsive.isMediumTablet(context) ||
      AkataboResponsive.isLargeTablet(context);

  /// getter for isDesktop
  bool get isDesktopScreen => AkataboResponsive.isDesktop(context);
}
